...
var UI = React.createClass({
    ...
    render: function() {
        return (
            <div>
              <div className="">
                <span id="studySelect" style={{display:"inline-block"}}>
                  <span>Add Study</span>
...
var TimeZoneButton = React.createClass({
    ...
    render: function() {
        var self = this;
        return (
           <span style={{display:"inline-block"}}><TimeZone ref ="modal" ciq={this.state.ciq}/> <button onClick={this.onClick}>Select Timezone</button></span>
        )
    }
});
